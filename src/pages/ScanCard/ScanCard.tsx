import {IonButton, IonButtons, IonContent, IonHeader, IonIcon, IonPage, IonTitle, IonToolbar, useIonLoading, IonBackButton, IonItem, IonLabel, IonInput} from "@ionic/react";
        ...
        <IonPage>
            ...
            <IonContent fullscreen>
                ...
                <div style={{padding: '3%'}}>
                    ...
                    <IonItem>
                        <IonLabel position="fixed">Company</IonLabel>
                        <IonInput></IonInput>
                    </IonItem>
                    <IonItem>
